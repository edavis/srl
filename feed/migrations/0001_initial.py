...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feed_feed', (
            ...
            ('xml_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('html_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Category'])),
    ...
    models = {
        ...
        u'feed.feed': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.Category']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'xml_url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        }
    }
